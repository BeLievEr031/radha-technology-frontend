...
export function Launch({ width = 60, height = 60, className }: IProp) {
...
export function UserPlus({ width = 60, height = 60, className }: IProp) {
...
export function PackageSearch({ width = 60, height = 60, className }: IProp) {
...
export function Earth({ width = 60, height = 60, className }: IProp) {
...
export function Scaling({ width = 60, height = 60, className }: IProp) {
